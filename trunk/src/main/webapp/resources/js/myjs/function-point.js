...
var projectID;
  ...
  function getValue() {
		...
		json ={"uiSimple":uiSimple,"uiAverage":uiAverage,"uiComplex":uiComplex,
				...
				"rf8":rf8,"rf9":rf9,"rf10":rf10,"rf11":rf11,"rf12":rf12,"rf13":rf13,
				"rf14":rf14,"projectID":projectID, "wage":wage};
  }
  ...
  $.ajax({
	    ...
	    success: function(data) {
	    	document.getElementById("totalfp").innerHTML = data.totalFP;
	    	document.getElementById("costfp").innerHTML = data.cost;    	      
	   	},
	    error: function() {
	    }
	}); 	          
