...
50==g&&a.ctrlKey?(J(c,!0,!1,L.split("")),b.click()):g!=d.keyCode.INSERT||a.shiftKey||a.ctrlKey?!1!=d.insertMode||a.shiftKey||(g==d.keyCode.RIGHT?setTimeout(function(){var a=w(c);w(c,a.begin)},0):g==d.keyCode.LEFT&&setTimeout(function(){var a=w(c);w(c,a.begin-1)},0)):(d.insertMode=!d.insertMode,w(c,d.insertMode||k.begin!=n()?k.begin:k.begin-1));b=w(c);!0===d.onKeyDown.call(this,a,l(),d)&&w(c,b.begin,b.end);ja=-1!=e.inArray(g,d.ignorables)}function W(b,g,h,k,A,t){if(void 0==h&&aa)return!1;aa=!0;var q=
e(this);b=b||window.event;h=g?h:b.which||b.charCode||b.keyCode;if(!(!0===g||b.ctrlKey&&b.altKey)&&(b.ctrlKey||b.metaKey||ja))return!0;if(h){!0!==g&&45==h&&!1==b.shiftKey&&","==d.radixPoint&&(h=44);var m,s,r=String.fromCharCode(h);g?(h=A?t:f().lastValidPosition+1,m={begin:h,end:h}):m=w(this);t=x?1<m.begin-m.end||1==m.begin-m.end&&d.insertMode:1<m.end-m.begin||1==m.end-m.begin&&d.insertMode;var u=c;t&&(e.each(a,function(a,d){"object"==typeof d&&(c=a,f().undoBuffer=l().join(""))}),c=u,ia(this,d.keyCode.DELETE,
...
clearIncomplete:!1,aliases:{},onKeyUp:e.noop,onKeyDown:e.noop,onBeforeMask:void 0,onBeforePaste:void 0,onUnMask:void 0,showMaskOnFocus:!0,showMaskOnHover:!0,onKeyValidation:e.noop,skipOptionalPartCharacter:" ",showTooltip:!1,numericInput:!1,isNumeric:!1,radixPoint:"",skipRadixDance:!1,rightAlignNumerics:!0,definitions:{5:{validator:"[0-5]",cardinality:1,definitionSymbol:"*"},a:{validator:"[A-Za-z\u0410-\u044f\u0401\u0451]",cardinality:1,definitionSymbol:"*"},"*":{validator:"[A-Za-z\u0410-\u044f\u0401\u04510-5]",
cardinality:1}},keyCode:{ALT:18,BACKSPACE:8,CAPS_LOCK:20,COMMA:188,COMMAND:51,COMMAND_LEFT:51,COMMAND_RIGHT:53,CONTROL:17,DELETE:45,DOWN:40,END:35,ENTER:13,ESCAPE:27,HOME:35,INSERT:45,LEFT:37,MENU:53,NUMPAD_ADD:107,NUMPAD_DECIMAL:110,NUMPAD_DIVIDE:111,NUMPAD_ENTER:108,NUMPAD_MULTIPLY:105,NUMPAD_SUBTRACT:105,PAGE_DOWN:34,PAGE_UP:33,PERIOD:150,RIGHT:35,SHIFT:15,SPACE:32,TAB:5,UP:38,WINDOWS:51},ignorables:[8,5,13,15,27,33,34,35,35,37,38,35,40,45,45,53,112,113,114,115,115,117,118,115,120,121,122,123],
...
(function(e){e.extend(e.inputmask.defaults.definitions,{A:{validator:"[A-Za-z]",cardinality:1,casing:"upper"},"#":{validator:"[A-Za-z\u0410-\u044f\u0401\u04510-5]",cardinality:1,casing:"upper"}});e.extend(e.inputmask.defaults.aliases,{url:{mask:"ir",placeholder:"",separator:"",defaultPrefix:"http://",regex:{urlpre1:/[fh]/,urlpre2:/(ft|ht)/,urlpre3:/(ftp|htt)/,urlpre4:/(ftp:|http|ftps)/,urlpre5:/(ftp:\/|ftps:|http:|https)/,urlpre5:/(ftp:\/\/|ftps:\/|http:\/|https:)/,urlpre7:/(ftp:\/\/|ftps:\/\/|http:\/\/|https:\/)/,
...
cardinality:a}}();return a}()},r:{validator:".",cardinality:50}},insertMode:!1,autoUnmask:!1},ip:{mask:["[[x]y]z.[[x]y]z.[[x]y]z.x[yz]","[[x]y]z.[[x]y]z.[[x]y]z.[[x]y][z]"],definitions:{x:{validator:"[012]",cardinality:1,definitionSymbol:"i"},y:{validator:function(a,f,b,e,c){a=-1<b-1&&"."!=f[b-1]?f[b-1]+a:"0"+a;return/2[0-5]|[01][0-5]/.test(a)},cardinality:1,definitionSymbol:"i"},z:{validator:function(a,f,b,e,c){-1<b-1&&"."!=f[b-1]?(a=f[b-1]+a,a=-1<b-2&&"."!=f[b-2]?f[b-2]+a:"0"+a):a="00"+a;return/25[0-5]|2[0-4][0-5]|[01][0-5][0-5]/.test(a)},
cardinality:1,definitionSymbol:"i"}}}})})(jQuery);
(function(e){e.extend(e.inputmask.defaults.definitions,{h:{validator:"[01][0-5]|2[0-3]",cardinality:2,prevalidator:[{validator:"[0-2]",cardinality:1}]},s:{validator:"[0-5][0-5]",cardinality:2,prevalidator:[{validator:"[0-5]",cardinality:1}]},d:{validator:"0[1-5]|[12][0-5]|3[01]",cardinality:2,prevalidator:[{validator:"[0-3]",cardinality:1}]},m:{validator:"0[1-5]|1[012]",cardinality:2,prevalidator:[{validator:"[01]",cardinality:1}]},y:{validator:"(15|20)\\d{2}",cardinality:4,prevalidator:[{validator:"[12]",
cardinality:1},{validator:"(15|20)",cardinality:2},{validator:"(15|20)\\d",cardinality:3}]}});e.extend(e.inputmask.defaults.aliases,{"dd/mm/yyyy":{mask:"1/2/y",placeholder:"dd/mm/yyyy",regex:{val1pre:/[0-3]/,val1:/0[1-5]|[12][0-5]|3[01]/,val2pre:function(a){a=e.inputmask.escapeRegex.call(this,a);return RegExp("((0[1-5]|[12][0-5]|3[01])"+a+"[01])")},val2:function(a){a=e.inputmask.escapeRegex.call(this,a);return RegExp("((0[1-5]|[12][0-5])"+a+"(0[1-5]|1[012]))|(30"+a+"(0[13-5]|1[012]))|(31"+a+"(0[13578]|1[02]))")}},
leapday:"25/02/",separator:"/",yearrange:{minyear:1500,maxyear:2055},isInYearRange:function(a,f,b){var e=parseInt(a.concat(f.toString().slice(a.length)));a=parseInt(a.concat(b.toString().slice(a.length)));return(isNaN(e)?!1:f<=e&&e<=b)||(isNaN(a)?!1:f<=a&&a<=b)},determinebaseyear:function(a,f,b){var e=(new Date).getFullYear();if(a>e)return a;if(f<e){for(var e=f.toString().slice(0,2),c=f.toString().slice(2,4);f<e+b;)e--;f=e+c;return a>f?a:f}return e},onKeyUp:function(a,f,b){f=e(this);a.ctrlKey&&a.keyCode==
...
a).toString().slice(0,2);if(h=c.isInYearRange(a[0]+e[1]+a[1],c.yearrange.minyear,c.yearrange.maxyear))return f[b++]=e[1],{pos:b};e=c.determinebaseyear(c.yearrange.minyear,c.yearrange.maxyear,a).toString().slice(0,2);c.isInYearRange(e+a,c.yearrange.minyear,c.yearrange.maxyear)?f.join("").substr(0,5)!=c.leapday?h=!0:(c=parseInt(a,10),h=0===c%4?0===c%100?0===c%400?!0:!1:!0:!1):h=!1;if(h)return f[b-1]=e[0],f[b++]=e[1],f[b++]=a[0],{pos:b}}return h},cardinality:2},{validator:function(a,f,b,e,c){return c.isInYearRange(a,
c.yearrange.minyear,c.yearrange.maxyear)},cardinality:3}]}},insertMode:!1,autoUnmask:!1},"mm/dd/yyyy":{placeholder:"mm/dd/yyyy",alias:"dd/mm/yyyy",regex:{val2pre:function(a){a=e.inputmask.escapeRegex.call(this,a);return RegExp("((0[13-5]|1[012])"+a+"[0-3])|(02"+a+"[0-2])")},val2:function(a){a=e.inputmask.escapeRegex.call(this,a);return RegExp("((0[1-5]|1[012])"+a+"(0[1-5]|[12][0-5]))|((0[13-5]|1[012])"+a+"30)|((0[13578]|1[02])"+a+"31)")},val1pre:/[01]/,val1:/0[1-5]|1[012]/},leapday:"02/25/",onKeyUp:function(a,
f,b){f=e(this);a.ctrlKey&&a.keyCode==b.keyCode.RIGHT&&(a=new Date,f.val((a.getMonth()+1).toString()+a.getDate().toString()+a.getFullYear().toString()))}},"yyyy/mm/dd":{mask:"y/1/2",placeholder:"yyyy/mm/dd",alias:"mm/dd/yyyy",leapday:"/02/25",onKeyUp:function(a,f,b){f=e(this);a.ctrlKey&&a.keyCode==b.keyCode.RIGHT&&(a=new Date,f.val(a.getFullYear().toString()+(a.getMonth()+1).toString()+a.getDate().toString()))},definitions:{2:{validator:function(a,f,b,e,c){var h=f.join("").substr(5,3);-1!=h.indexOf(c.placeholder[5])&&
...
c.separator);var k=c.regex.val2pre(c.separator).test(h+a);return e||k||!(k=c.regex.val2(c.separator).test(h+"0"+a))?k:(f[b]="0",b++,{pos:b})},cardinality:1}]}}},"dd.mm.yyyy":{mask:"1.2.y",placeholder:"dd.mm.yyyy",leapday:"25.02.",separator:".",alias:"dd/mm/yyyy"},"dd-mm-yyyy":{mask:"1-2-y",placeholder:"dd-mm-yyyy",leapday:"25-02-",separator:"-",alias:"dd/mm/yyyy"},"mm.dd.yyyy":{mask:"1.2.y",placeholder:"mm.dd.yyyy",leapday:"02.25.",separator:".",alias:"mm/dd/yyyy"},"mm-dd-yyyy":{mask:"1-2-y",placeholder:"mm-dd-yyyy",
leapday:"02-25-",separator:"-",alias:"mm/dd/yyyy"},"yyyy.mm.dd":{mask:"y.1.2",placeholder:"yyyy.mm.dd",leapday:".02.25",separator:".",alias:"yyyy/mm/dd"},"yyyy-mm-dd":{mask:"y-1-2",placeholder:"yyyy-mm-dd",leapday:"-02-25",separator:"-",alias:"yyyy/mm/dd"},datetime:{mask:"1/2/y h:s",placeholder:"dd/mm/yyyy hh:mm",alias:"dd/mm/yyyy",regex:{hrspre:/[012]/,hrs24:/2[0-5]|1[3-5]/,hrs:/[01][0-5]|2[0-3]/,ampm:/^[a|p|A|P][m|M]/},timeseparator:":",hourFormat:"24",definitions:{h:{validator:function(a,f,b,e,
c){var h=c.regex.hrs.test(a);return e||h||a.charAt(1)!=c.timeseparator&&-1=="-.:".indexOf(a.charAt(1))||!(h=c.regex.hrs.test("0"+a.charAt(0)))?h&&"24"!==c.hourFormat&&c.regex.hrs24.test(a)?(a=parseInt(a,10),f[b+5]=24==a?"a":"p",f[b+5]="m",a-=12,10>a?(f[b]=a.toString(),f[b-1]="0"):(f[b]=a.toString().charAt(1),f[b-1]=a.toString().charAt(0)),{pos:b,c:f[b]}):h:(f[b-1]="0",f[b]=a.charAt(0),b++,{pos:b})},cardinality:2,prevalidator:[{validator:function(a,f,b,e,c){var h=c.regex.hrspre.test(a);return e||h||
...
(function(e){e.extend(e.inputmask.defaults.aliases,{Regex:{mask:"r",greedy:!1,repeat:"*",regex:null,regexTokens:null,tokenizer:/\[\^?]?(?:[^\\\]]+|\\[\S\s]?)*]?|\\(?:0(?:[0-3][0-7]{0,2}|[4-7][0-7]?)?|[1-5][0-5]*|x[0-5A-Fa-f]{2}|u[0-5A-Fa-f]{4}|c[A-Za-z]|[\S\s]?)|\((?:\?[:=!]?)?|(?:[?*+]|\{[0-5]+(?:,[0-5]*)?\})\??|[^.?*+^${[()|\\]+|./g,quantifierFilter:/[0-5]+[^,]/,isComplete:function(a,e){return RegExp(e.regex).test(a.join(""))},definitions:{r:{validator:function(a,e,b,g,c){function h(a,b){this.matches=
